...
namespace SIS.WebServer
{
    public class ConnectionHandler
    {
        ...
        public async Task ProcessRequestAsync()
        {
            ...
            {
                await this.PrepareResponse(new BadRequestResult(e.InnerException.Message + e.Message));
            }
            catch (Exception e)
            {
                await this.PrepareResponse(new InternalServerErrorResult(e.StackTrace + e.Message + e.InnerException.Message));
            }
